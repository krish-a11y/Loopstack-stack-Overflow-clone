"use client";
// page  that shows questions that is given to it
...
const QuestionCard=({ques}:{ques:Question})=>
{
  ...
  // gives  react direct access to the DOM elements
  const ref=useRef<HTMLDivElement>(null);

  // set the height of the card as per the height of the dov to which element ref is refrencing
